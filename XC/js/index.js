/***********************顶部导航条****************************/
//实现 语言 弹窗
$('li.language-1').mouseover(function(){
    $(this).children('.selected').addClass('hover');
    $(this).children('.language-wrap').show();
})
$('li.language-1').mouseout(function(){
    $(this).children('.selected').removeClass('hover');
    $(this).children('.language-wrap').hide();
})
// 我的携程 弹窗
$('li.ctrip').mouseover(function(){
    $(this).children('.my-ctrip').addClass('hover');
    $(this).children('.my-xc').show();
})
$('li.ctrip').mouseout(function(){
    $(this).children('.my-ctrip').removeClass('hover');
    $(this).children('.my-xc').hide();
})
//我的订单 弹窗
$('li.indent').mouseover(function(){
    $(this).children('.my-indent').addClass('hover');
    $(this).children('.my-order').show();
})
$('li.indent').mouseout(function(){
    $(this).children('.my-indent').removeClass('hover');
    $(this).children('.my-order').hide();
})
//APP
$('li.app').mouseover(function(){
    $(this).children('.my-app').addClass('hover');
    $(this).children('.phone-ma').show();
})
$('li.app').mouseout(function(){
    $(this).children('.my-app').removeClass('hover');
    $(this).children('.phone-ma').hide();
})
//微信
$('li.wechat').mouseover(function(){
    $(this).children('.my-wechat').addClass('hover');
    $(this).children('.wechat-ma').show();
})
$('li.wechat').mouseout(function(){
    $(this).children('.my-wechat').removeClass('hover');
    $(this).children('.wechat-ma').hide();
})
/*****************************导航*****************************/
//实现导航菜单弹窗
